...
<div class="flex min-h-screen flex-col pb-20">
    ...
    {#if store}
      <div class="mb-6 rounded-xl border border-border bg-card p-6">
        <div class="flex items-center gap-3">
          <div
            class="flex h-12 w-12 items-center justify-center rounded-full bg-secondary/50"
          >
  ...
  <form
    method="POST"
    action="?/logout"
    class="sticky bottom-0 border-t border-border bg-background/95 p-4 backdrop-blur-sm"
  >
