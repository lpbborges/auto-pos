...
test.describe('Sales', () => {
  ...
  test('should add product to cart', async ({ page }) => {
    ...
    await expect(page.locator('button:has-text("Carrinho")')).toContainText('1')
  })
...
test.describe('Sales History', () => {
  ...
  test('should filter by today', async ({ page }) => {
    ...
    await expect(
      page.locator("button.bg-primary:has-text('Hoje')"),
    ).toBeVisible()
  })
  ...
  test('should filter by week', async ({ page }) => {
    ...
    await expect(
      page.locator("button.bg-primary:has-text('7 dias')"),
    ).toBeVisible()
  })
  ...
  test('should filter by month', async ({ page }) => {
    ...
    await expect(
      page.locator("button.bg-primary:has-text('Mês')"),
    ).toBeVisible()
  })
